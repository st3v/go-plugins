...
import (
	...
	"github.com/micro/go-plugins/Godeps/_workspace/src/github.com/prometheus/client_golang/prometheus"
	"github.com/micro/go-plugins/Godeps/_workspace/src/golang.org/x/crypto/ssh"
)
