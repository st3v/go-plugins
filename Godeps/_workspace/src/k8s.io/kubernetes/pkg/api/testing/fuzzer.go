...
import (
	...
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/registered"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/resource"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/unversioned"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/apis/extensions"
	...
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/types"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/intstr"

	"github.com/micro/go-plugins/Godeps/_workspace/src/github.com/google/gofuzz"
)
