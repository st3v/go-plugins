...
import (
	...
	flag "github.com/micro/go-plugins/Godeps/_workspace/src/github.com/spf13/pflag"
	"github.com/micro/go-plugins/Godeps/_workspace/src/speter.net/go/exp/math/dec/inf"
)
