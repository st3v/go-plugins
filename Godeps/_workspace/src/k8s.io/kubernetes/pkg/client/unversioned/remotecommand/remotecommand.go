...
import (
	...
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/client/transport"
	client "github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/client/unversioned"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/httpstream"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/httpstream/spdy"
)
