...
import (
	...
	"github.com/micro/go-plugins/Godeps/_workspace/src/github.com/golang/glog"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/errors"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/unversioned"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/v1"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/validation"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/client/metrics"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/conversion/queryparams"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/fields"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/labels"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/runtime"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/sets"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/watch"
	watchjson "github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/watch/json"
)
