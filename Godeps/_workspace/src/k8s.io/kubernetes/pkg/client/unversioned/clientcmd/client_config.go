...
import (
	...
	clientauth "github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/client/unversioned/auth"
	clientcmdapi "github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/client/unversioned/clientcmd/api"
)
