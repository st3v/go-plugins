...
import (
	...
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/apis/metrics"
	"github.com/micro/go-plugins/Godeps/_workspace/src/k8s.io/kubernetes/pkg/apis/metrics/v1alpha1"
